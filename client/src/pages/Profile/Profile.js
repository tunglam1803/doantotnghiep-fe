...
const Profile = () => {
  ...
  const addNewAddress = async (values) => {
    try {
      ...
      await axios.post('http://192.168.189.110:8080/api/ship/save', values, {
  ...
  const fetchDefaultAddress = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.get('http://192.168.189.110:8080/api/ship/default', {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchOrderHistory = async () => {
    try {
      ...
      const response = await axios.get(`http://192.168.189.110:8080/api/orders/getOrderHistory/${userId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleChangePassword = async (values) => {
    try {
      ...
      const response = await axios.post(
        'http://192.168.189.110:8080/api/users/changePassword',
        {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        const response = await axios.get('http://192.168.189.110:8080/api/users/profile', {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const handleUpdateProfile = async (values) => {
    try {
      ...
      const response = await axios.put(
        'http://192.168.189.110:8080/api/users/updateProfile',
